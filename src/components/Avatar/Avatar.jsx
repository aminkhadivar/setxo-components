...
export default function Avatar({ children, url, alt, as = 'image', size, height = '48', className = '', rounded = 'rounded' , border = '', ...props }) {

    const DefaultAvatar = () => {
        return (
            <svg className="fill-gray-400" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
